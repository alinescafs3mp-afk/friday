...
`SOURCE_REVISION` в budget/ENV — tree SHA-256 нового кандидата. С 0.208.6
...
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.207.99/schema50` DDL не меняет, принимает exact `0.207.98/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.0/schema50` DDL не меняет, принимает exact `0.207.99/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.1/schema50` DDL не меняет, принимает exact `0.208.0/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
...
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.5/schema50` DDL не меняет, принимает exact `0.208.3/schema50` как
previous (`0.208.4` sibling не стал live) и сохраняет `0.207.90/schema50`
immutable fallback.
`0.208.6/schema50` DDL не меняет, принимает exact `0.208.5/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
...
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.9/schema50` DDL не меняет, принимает exact `0.208.8/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.10/schema50` DDL не меняет, принимает exact `0.208.9/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.11/schema50` DDL не меняет, принимает exact `0.208.10/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.12/schema50` DDL не меняет, принимает exact `0.208.11/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.13/schema50` DDL не меняет, принимает exact `0.208.12/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.14/schema50` DDL не меняет, принимает exact `0.208.13/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.15/schema50` DDL не меняет, принимает exact `0.208.14/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.16/schema50` DDL не меняет, принимает exact `0.208.15/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.17/schema50` DDL не меняет, принимает exact `0.208.16/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.18/schema50` DDL не меняет, принимает exact `0.208.17/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.19/schema50` DDL не меняет, принимает exact `0.208.18/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.20/schema50` DDL не меняет, принимает exact `0.208.19/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.21/schema50` DDL не меняет, принимает exact `0.208.20/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.22/schema50` DDL не меняет, принимает exact `0.208.21/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.23/schema50` DDL не меняет, принимает exact `0.208.22/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.24/schema50` DDL не меняет, принимает exact `0.208.23/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.25/schema50` DDL не меняет, принимает exact `0.208.24/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.26/schema50` DDL не меняет, принимает exact `0.208.25/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.27/schema50` DDL не меняет, принимает exact `0.208.26/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.28/schema50` DDL не меняет, принимает exact `0.208.27/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.29/schema50` DDL не меняет, принимает exact `0.208.28/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.30/schema50` DDL не меняет, принимает exact `0.208.29/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.31/schema50` DDL не меняет, принимает exact `0.208.30/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.32/schema50` DDL не меняет, принимает exact `0.208.31/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.33/schema50` DDL не меняет, принимает exact `0.208.32/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.34/schema50` DDL не меняет, принимает exact `0.208.33/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.35/schema50` DDL не меняет, принимает exact `0.208.34/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.36/schema50` DDL не меняет, принимает exact `0.208.35/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.37/schema50` DDL не меняет, принимает exact `0.208.36/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.38/schema50` DDL не меняет, принимает exact `0.208.37/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
...
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.41/schema50` DDL не меняет, принимает exact `0.208.40/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.42/schema50` DDL не меняет, принимает exact `0.208.41/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.43/schema50` DDL не меняет, принимает exact `0.208.42/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.44/schema50` DDL не меняет, принимает exact `0.208.43/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.45/schema50` DDL не меняет, принимает exact `0.208.44/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.46/schema50` DDL не меняет, принимает exact `0.208.45/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.47/schema50` DDL не меняет, принимает exact `0.208.46/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.48/schema50` DDL не меняет, принимает exact `0.208.47/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.49/schema50` DDL не меняет, принимает exact `0.208.48/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.50/schema50` DDL не меняет, принимает exact `0.208.49/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.51/schema50` DDL не меняет, принимает exact `0.208.50/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.52/schema50` DDL не меняет, принимает exact `0.208.51/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.53/schema50` DDL не меняет, принимает exact `0.208.52/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.54/schema50` DDL не меняет, принимает exact `0.208.52/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.55/schema50` DDL не меняет, принимает exact `0.208.54/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.56/schema50` DDL не меняет, принимает exact `0.208.55/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
`0.208.57/schema50` DDL не меняет, принимает exact `0.208.56/schema50` как
previous и сохраняет `0.207.90/schema50` immutable fallback.
Кандидат `0.208.58/schema50` DDL не меняет. Для его предстоящей активации
`0.208.57/schema50` используется как previous и совместимый immutable fallback;
копия `0.208.56/schema50` сохраняется. Эта схема перехода не подтверждает
выполнение приёмки или активации кандидата.
...
Для file+web comparison verifier-reserve на 8192 остаётся 1328 JSON байт,
а на 32768/40960 — 5312, поэтому полная крупная проекция на q38 по-прежнему
помещается. Post-synthesis accept на 40960 — линейные 6640, поэтому
small-input на q38 берёт 40960, чтобы принять полный русский синтез.
...
требуйте `status=ok` и `version=0.208.58`.
