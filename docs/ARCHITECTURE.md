...
Скор cross-encoder **откалиброван** — это не относительная величина внутри выдачи, как слитый скор, а близкая к вероятности оценка «этот документ отвечает». На живом архиве «график дежурств» даёт пять штук по 0.999, а вопрос, ответа на который в архиве нет, уводит **весь пул ниже 0.01**. Это первый сигнал, по которому Jericho может отличить «не нашёл» от «нашёл не то».
...
вроде «Период Отработано Оплачено», попавшие в жадный захват). Отсюда правило:
...
строках — «Вооруженных Силах Российской» размечено ложным, а после обрезки это
«Вооруженных Силах», размеченное настоящим; сравнение со старой меткой ничего не
