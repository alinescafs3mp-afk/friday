...
Ни worker, ни scan не применяют изменения автоматически. Hard delete, hidden deprecation, массовая переклассификация и silent merge отсутствуют.
