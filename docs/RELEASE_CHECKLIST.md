...
Контракт RC → 1.0, дополнительные пользовательские наборы и точные команды диагностического/финального прогона: [`RELEASE_1_0_ACCEPTANCE.md`](RELEASE_1_0_ACCEPTANCE.md). Готовность той батареи не означает приёмку продукта как 1.0. Этот checklist и exact-release не ослабляются.
...
- release принимается и первый раз запускается без `FRIDAY_SECONDARY_LLM_*`:
  health имеет `status=ok`, `version=0.208.58`, `secondary.mode=disabled`,
...
- final startup health имеет `status=ok`, `version=0.208.58`, configured/installed,
...
- q38 выбирает только минимально достаточный closed tier из
  ...
  резервирует worst-case JSON синтеза для verifier (на 40960 это 5312 байт),
  а post-synthesis accept на 40960 — 6640 байт, поэтому small-input на q38
  берёт 40960, а полная крупная проекция остаётся 40960 без усечения;
...
- `0.208.22/schema50` принимает exact `0.208.21` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.23/schema50` принимает exact `0.208.22` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.24/schema50` принимает exact `0.208.23` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.25/schema50` принимает exact `0.208.24` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.26/schema50` принимает exact `0.208.25` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.27/schema50` принимает exact `0.208.26` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.28/schema50` принимает exact `0.208.27` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.29/schema50` принимает exact `0.208.28` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.30/schema50` принимает exact `0.208.29` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.31/schema50` принимает exact `0.208.30` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.32/schema50` принимает exact `0.208.31` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.33/schema50` принимает exact `0.208.32` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.34/schema50` принимает exact `0.208.33` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.35/schema50` принимает exact `0.208.34` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.36/schema50` принимает exact `0.208.35` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.37/schema50` принимает exact `0.208.36` как previous и сохраняет
  `0.207.90` immutable fallback;
...
- `0.208.40/schema50` принимает exact `0.208.39` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.41/schema50` принимает exact `0.208.40` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.42/schema50` принимает exact `0.208.41` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.43/schema50` принимает exact `0.208.42` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.44/schema50` принимает exact `0.208.43` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.45/schema50` принимает exact `0.208.44` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.46/schema50` принимает exact `0.208.45` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.47/schema50` принимает exact `0.208.46` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.48/schema50` принимает exact `0.208.47` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.49/schema50` принимает exact `0.208.48` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.50/schema50` принимает exact `0.208.49` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.51/schema50` принимает exact `0.208.50` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.52/schema50` принимает exact `0.208.51` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.53/schema50` принимает exact `0.208.52` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.54/schema50` принимает exact `0.208.52` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.55/schema50` принимает exact `0.208.54` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.56/schema50` принимает exact `0.208.55` как previous и сохраняет
  `0.207.90` immutable fallback;
- `0.208.57/schema50` принимает exact `0.208.56` как previous и сохраняет
  `0.207.90` immutable fallback;
- для кандидата `0.208.58/schema50` previous и совместимый immutable fallback —
  exact `0.208.57/schema50`; копия `0.208.56` сохраняется. Полная приёмка и
  активация кандидата остаются обязательными;
