...
def _live_cases() -> tuple[QualityCase, ...]:
    ...
    return (
        ...
        QualityCase(
            ...
            _base_messages(
                "Составь одно русское предложение без новых фактов или чисел. Начни предложение "
                "дословно так: «Проект „Север“: бюджет 17 рублей, срок ». Затем напиши дату срока "
                "либо «24.08.2026», либо «24 августа 2026 года» и поставь точку. Ничего больше "
                "не добавляй. Исходные факты: проект «Север»; бюджет 17 рублей; срок 24.08.2026."
            ),
