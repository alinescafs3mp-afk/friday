...
$dockerDesktopCachePath = '/run/desktop/mnt/host/d/jarvis/cache/sglang-qwen38-abliterated-v12-attested'
Assert-Accepted $cachePath $cachePath
Assert-Accepted 'D:/jarvis/cache/sglang-qwen38-abliterated-v12-attested' $cachePath
...
Assert-Accepted 'D:/jarvis/data/models/qwen3.8-27b-abliterated-nvfp4-vtuber-43aa7ff5' $modelPath
Assert-Accepted '/run/desktop/mnt/host/d/jarvis/data/models/qwen3.8-27b-abliterated-nvfp4-vtuber-43aa7ff5' `
    $modelPath

foreach ($mutation in @(
    'D:\jarvis/cache\sglang-qwen38-abliterated-v12-attested',
    'D:/jarvis\cache/sglang-qwen38-abliterated-v12-attested',
    'd:\jarvis\cache\sglang-qwen38-abliterated-v12-attested',
    'd:/jarvis/cache/sglang-qwen38-abliterated-v12-attested',
    'E:\jarvis\cache\sglang-qwen38-abliterated-v12-attested',
    'D:\Jarvis\cache\sglang-qwen38-abliterated-v12-attested',
    'D:\jarvis\cache\..\cache\sglang-qwen38-abliterated-v12-attested',
    'D:\jarvis\cache\sglang-qwen38-abliterated-v12-attested\',
    '\\?\D:\jarvis\cache\sglang-qwen38-abliterated-v12-attested',
    '/run/desktop/mnt/host/c/jarvis/cache/sglang-qwen38-abliterated-v12-attested',
    '/run/desktop/mnt/host/D/jarvis/cache/sglang-qwen38-abliterated-v12-attested',
    '/Run/desktop/mnt/host/d/jarvis/cache/sglang-qwen38-abliterated-v12-attested',
    '/run/desktop/mnt/host/d/Jarvis/cache/sglang-qwen38-abliterated-v12-attested',
    '/run/desktop/mnt/host/d/jarvis/cache/../cache/sglang-qwen38-abliterated-v12-attested',
    '/run/desktop/mnt/host/d/jarvis/cache//sglang-qwen38-abliterated-v12-attested',
    '/run/desktop/mnt/host/d/jarvis/cache/sglang-qwen38-abliterated-v12-attested/',
    '/run/desktop/mnt/host/d/jarvis/cache/sglang-qwen38-abliterated-v12-attested-extra'
)) {
