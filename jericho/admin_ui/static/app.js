...
function navigate(view){state.view=view;resetPages();renderNav();document.getElementById('pageTitle').textContent=views.find(v=>v[0]===view)?.[1]||view;document.getElementById('sidebar').classList.remove('open');refresh()}
