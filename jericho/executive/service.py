...
primitives as the rest of Jericho.  It never writes knowledge or graph records
...
from jericho.executive.planner import MissionPlanner, PlannedTask
from jericho.ingestion import IdempotencyConflictError, IngestionPipeline
...
_TASK_SYSTEM_PROMPT = (
    "Ты исполнитель одного шага миссии Jericho. Используй доступные инструменты, "
