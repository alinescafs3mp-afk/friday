...
_RELATION_PHRASES: tuple[tuple[re.Pattern[str], RelationType, float, bool], ...] = (
    ...
    # «X является частью Y». Отдельный разбор очереди показал ту
...
class KnowledgeGraph:
    ...
    def find_relation_path(
        ...
        *,
        ...
        подсвечивается на картине с самого начала; в чате его не было, хотя
        Telegram — первичный интерфейс продукта.
