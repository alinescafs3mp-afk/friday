...
def hierarchy_is_configured(storage: Any) -> bool:
    ...
    Владелец 2026-08-04, на прямой вопрос о живой установке (руководителей ноль,
    значит каждый участник видит деятельность любого), решил: **«все видят
    всех»**. Это не недосмотр и не временное состояние — это выбор, и заводить
    его снова находкой ревью не нужно.

    Решение — про СМОТРЕТЬ. Право менять чужую учётку, выпускать на неё токены и
