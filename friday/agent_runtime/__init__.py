...
_MOMENT_IN_QUESTION = re.compile(
    ...
    r"понедельник\w*|вторник\w*|сред[ыуа]\b|четверг\w*|пятниц\w*|суббот\w*|воскресен\w*|"
...
_ASKS_FOR_THE_WEB = re.compile(
    ...
    # просьбу, поэтому середина слова не фиксируется жёстко.
    r"в\s+интер\w*|в\s+инете|в\s+сети\b|в\s+вебе|в\s+гугле|в\s+яндексе|"
