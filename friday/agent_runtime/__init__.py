    ...
    async def _prepare_context(
        ...
        *,
        ...
        if (
            ...
            and (household or _archive_is_weak(context.knowledge_hits))
        ):
            LOGGER.info(
                "archive-gate: бытовая реплика — %d документов не пойдут в ответ (%r)",
                ...
                [
                    {
                        ...
                        "content": (
                            ...
                            '{"вид": "интернет|знание|архив|человек|файл|действие|быт|материал|другое", '
                            ...
                            "человек — спрашивают, что писал, присылал или делал КОНКРЕТНЫЙ "
                            "участник этой системы: «что писал JBL», «чем занимался Пегас», "
                            "«активность Yato», а также короткое продолжение такого вопроса — "
                            "«а Пегас?», «а JBL», «а он что?». Имя клади в поле «кто».\n"
