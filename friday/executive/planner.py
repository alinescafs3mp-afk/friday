...
from friday.storage.models import TaskKind
...
_SYSTEM_PROMPT = (
    "Ты планировщик миссий Friday. Разбей цель пользователя на короткий "
...
class MissionPlanner:
    ...
    def __init__(self, settings: FridaySettings, llm: LLMRouter) -> None:
