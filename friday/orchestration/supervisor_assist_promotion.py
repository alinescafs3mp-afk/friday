...
# One genuine joined product turn is the minimum evidence needed to open the
# bounded, reversible assist experiment.  Twenty remains the operating target
# for a useful comparison window, but must not make the product unavailable on
# a low-traffic owner-only installation.
SUPERVISOR_ASSIST_PROMOTION_MIN_PRODUCT_OBSERVATIONS = 1
SUPERVISOR_ASSIST_PROMOTION_TARGET_PRODUCT_OBSERVATIONS = 20
...
__all__ = [
    ...
    "SUPERVISOR_ASSIST_PROMOTION_TARGET_PRODUCT_OBSERVATIONS",
    "SUPERVISOR_ASSIST_PROMOTION_POLICY_SHA256",
