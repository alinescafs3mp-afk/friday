...
class HybridSearcher:
    ...
    async def search(
        ...
        *,
        ...
        #
        # Абляция на 78 эталонах назвала `usage` ЕДИНСТВЕННЫМ сигналом с измеримым
        # эффектом, и эффект отрицательный: без него 4 случая лучше против 1 хуже,
        # порядок улучшается в 16 случаях против 3, p=0.0044 по MRR. Прямой прогон
        # подтвердил: recall@10 0.4872 → 0.5256, MRR 0.2216 → 0.2394.
        #
