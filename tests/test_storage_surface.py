...
EXPECTED_SIGNATURES: dict[str, str] = {
    ...
    "get_entity_graph": "(self, user_id: 'str', entity_id: 'str', depth: 'int' = 2, *, as_of: 'str' = '', entity_types: 'Sequence[str]' = (), relation_types: 'Sequence[str]' = (), min_weight: 'float' = 0.0) -> 'dict[str, Any]'",
