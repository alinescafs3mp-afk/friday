...
from friday.interaction_control_plane import ContinuationKind, TurnTrace, WorkRelation
...
async def _run_legacy_turn(settings, storage, monkeypatch) -> _StoredTurn:  # noqa: ANN001
