...
def test_checked_in_inventory_closes_semantics_tiers_parameters_and_host_boundaries() -> None:
    ...
    # Six A09 fault-grammar regression functions add1 MiB each; prior budgets remain exact.
    assert sum(rule.scratch_mb for rule in value.rules if rule.tier != "nightly") == 54_707
