...
def test_checked_in_inventory_closes_semantics_tiers_parameters_and_host_boundaries() -> None:
    ...
    assert sum(rule.scratch_mb for rule in value.rules if rule.tier != "nightly") == 14_670
    ...
    p0h_modules = {"tests/test_release_artifact_proc_probe.py": 23, "tests/test_release_artifact_retention.py": 51, "tests/test_release_artifact_retention_privileged_install.py": 1, "tests/test_release_dr_generation_authentication.py": 6, "tests/test_release_dr_generation_enrollment.py": 16, "tests/test_release_dr_generation_index.py": 35, "tests/test_release_dr_generation_lifecycle.py": 10, "tests/test_release_dr_generation_rehearsal.py": 50}
