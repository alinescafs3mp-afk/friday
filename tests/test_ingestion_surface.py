...
EXPECTED_SIGNATURES: dict[str, str] = {
    ...
    "ingest_file": "(self, user_id: 'str', file_path: 'Path | None', file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', media_kind: 'str' = '', metadata: 'dict[str, Any] | None' = None, source_ref: 'str' = '') -> 'dict[str, Any]'",
