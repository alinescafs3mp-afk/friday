...
EXPECTED_SIGNATURES: dict[str, str] = {
    ...
    "inspect_file_transient": "(self, file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', preview_chars: 'int' = 24000, archive_password: 'str | None' = None, metadata_only: 'bool' = False, turn_deadline: 'float | None' = None) -> 'dict[str, Any]'",
