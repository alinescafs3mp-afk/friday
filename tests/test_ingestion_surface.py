...
EXPECTED_SIGNATURES: dict[str, str] = {
    ...
    "ingest_file": "(self, user_id: 'str', file_path: 'Path | None', file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', media_kind: 'str' = '', metadata: 'dict[str, Any] | None' = None, source_ref: 'str' = '', force_review: 'bool' = False, archive_password: 'str | None' = None) -> 'dict[str, Any]'",
    ...
    "inspect_file_transient": "(self, file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', preview_chars: 'int' = 24000, archive_password: 'str | None' = None, metadata_only: 'bool' = False) -> 'dict[str, Any]'",
