...
EXPECTED_SIGNATURES: dict[str, str] = {
    ...
    "_extract_visual_batch": "(self, assets: 'Sequence[VisualAsset]', *, asset_offset: 'int', summary_language: 'str' = '') -> 'dict[str, Any]'",
    "_extract_visual_document": "(self, file_content: 'bytes', *, filename: 'str', mime_type: 'str', preferred_language: 'str' = '') -> 'dict[str, Any] | None'",
    ...
    "_transcribe_audio": "(self, content: 'bytes', *, filename: 'str', mime_type: 'str', metadata: 'dict[str, Any] | None', turn_deadline: 'float | None' = None) -> 'dict[str, Any] | None'",
    ...
    "ingest_file": "(self, user_id: 'str', file_path: 'Path | None', file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', media_kind: 'str' = '', metadata: 'dict[str, Any] | None' = None, source_ref: 'str' = '', force_review: 'bool' = False, archive_password: 'str | None' = None, exact_byte_identity_only: 'bool' = False, opaque_exact_bytes_only: 'bool' = False, turn_deadline: 'float | None' = None) -> 'dict[str, Any]'",
    "ingest_text": "(self, user_id: 'str', content: 'str', *, source: 'str' = 'telegram', source_ref: 'str' = '', force_knowledge: 'bool' = False, force_review: 'bool' = False, metadata: 'dict[str, Any] | None' = None, turn_deadline: 'float | None' = None, _authenticated_turn_context: 'AuthenticatedTurnContext | None' = None) -> 'dict[str, Any]'",
    "inspect_file_transient": "(self, file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', preview_chars: 'int' = 24000, archive_password: 'str | None' = None, metadata_only: 'bool' = False, preferred_language: 'str' = '', turn_deadline: 'float | None' = None) -> 'dict[str, Any]'",
