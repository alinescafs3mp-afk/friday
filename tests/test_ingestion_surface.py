...
EXPECTED_SIGNATURES: dict[str, str] = {
    ...
    "ingest_file": "(self, user_id: 'str', file_path: 'Path | None', file_content: 'bytes', *, filename: 'str' = '', mime_type: 'str' = '', media_kind: 'str' = '', metadata: 'dict[str, Any] | None' = None, source_ref: 'str' = '', force_review: 'bool' = False, archive_password: 'str | None' = None, exact_byte_identity_only: 'bool' = False, turn_deadline: 'float | None' = None) -> 'dict[str, Any]'",
    "ingest_text": "(self, user_id: 'str', content: 'str', *, source: 'str' = 'telegram', source_ref: 'str' = '', force_knowledge: 'bool' = False, force_review: 'bool' = False, metadata: 'dict[str, Any] | None' = None, turn_deadline: 'float | None' = None) -> 'dict[str, Any]'",
