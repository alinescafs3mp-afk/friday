...
@pytest.mark.parametrize("label,value", [("готово", "UNIT-52"), ("согласовано", "Заказ-17"), ("ready", "alpha_42")])
...
@pytest.mark.parametrize("answer", [
    ...
    "*WRONG-7*", "*owned-7*", "*OWNED-7* *OWNED-7*",
    "Описание: *OWNED-7*", "*OWNED-7*\nСтрока с фактом.",
    "*готово OWNED-7*", "**готово** *OWNED-7*", "`*OWNED-7*`",
])
