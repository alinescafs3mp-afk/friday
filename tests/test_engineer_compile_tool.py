...
@pytest.mark.parametrize(
    ...
    (
        ...
        "Скомпилируй Main.java, комментарии не нужны, просто отправь бинарник.",
        "Friday, compile Main.java.",
        "Пятница, скомпилируй Main.java.",
        "Could you, please, compile Main.java?",
        "Compile Main.java and explain the source to me.",
        "Скомпилируй Main.java и объясни мне, что делает код.",
        "Скомпилируй Main.java и объясни, как работает код.",
        "Скомпилируй Main.java и проверь исходник на уязвимости.",
        "The source is attached. Please compile Main.java.",
        "I uploaded Main.java. Compile Main.java.",
        "I've uploaded Main.java. Compile Main.java.",
        "Main.java has been uploaded. Compile Main.java.",
        "Compile Main.java and explain what this code is doing.",
        "Compile Main.java and review the source for defects.",
        "Compile Main.java and please send me the JAR.",
        "Compile Main.java and send the JAR to me.",
        "Скомпилируй Main.java и объясни, как работает этот код.",
        "Скомпилируй Main.java и, пожалуйста, пришли JAR.",
        "Compile Main.java and provide the resulting JAR.",
        "Compile Main.java, then return the JAR.",
        "Скомпилируй Main.java и предоставь готовый JAR.",
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "Compile Main.java? No.",
        "Compile Main.java? Actually, no.",
        "Compile Main.java? No, thanks.",
        "Compile Main.java? No thank you.",
        "Compile Main.java? Nope.",
        "Compile Main.java? Nah.",
        "Compile Main.java? I'd rather not.",
        "Compile Main.java? I'd rather you didn't.",
        "Compile Main.java? Better not.",
        "Compile Main.java? Let's not.",
        "Compile Main.java? Could you not do that, please?",
        "Compile Main.java? Sorry, I don't want you to do that.",
        "Compile Main.java? Please don't.",
        "Compile Main.java? No, please do not.",
        "Compile Main.java? No, thank you very much.",
        "Compile Main.java, no thanks.",
        "Compile Main.java? Forget it.",
        "Скомпилируй Main.java? Нет.",
        "Скомпилируй Main.java? Нет, спасибо.",
        "Скомпилируй Main.java? Нет, благодарю вас.",
        "Скомпилируй Main.java? Неа.",
        "Скомпилируй Main.java? Я лучше не буду.",
        "Скомпилируй Main.java? Давай не будем.",
        "Compile Main.java means what?",
        "Compile Main.java — what does that mean?",
        "Compile Main.java — explain what that means.",
        "Compile Main.java — please explain what that means.",
        "Compile Main.java — please explain to me what that means.",
        "Compile Main.java — can you explain what that means?",
        "Compile Main.java — could you clarify what this command means?",
        "Compile Main.java — what is that supposed to mean?",
        "Compile Main.java — what is meant by that?",
        "Compile Main.java — how should I understand that?",
        "Скомпилируй Main.java — что это значит?",
        "Скомпилируй Main.java — объясни, что это значит.",
        "Скомпилируй Main.java — пожалуйста, объясни, что это значит.",
        "Скомпилируй Main.java — пожалуйста, объясните мне, что это значит.",
        "Скомпилируй Main.java — можешь объяснить, что это значит?",
        "Скомпилируй Main.java — что означает эта команда?",
        ...
        "Alice's request; compile Main.java.",
        "For reference. Compile Main.java.",
        "This is Bob's wish. Compile Main.java and review the code.",
        "How should I interpret this? Compile Main.java and review the code.",
        "По просьбе Алисы. Скомпилируй Main.java.",
        "Это желание Боба. Скомпилируй Main.java и проверь код.",
        "If tests pass. Then compile Main.java.",
        "When tests pass. Then compile Main.java.",
        "After I approve. Then compile Main.java.",
        "Only after my approval. Then compile Main.java.",
        "Wait for my approval. Then compile Main.java.",
        "This is Bob's wish. Finally, compile Main.java.",
        "Это желание Боба. Наконец, скомпилируй Main.java.",
        "Until I approve. Now compile Main.java.",
        "Subject to my approval. Now compile Main.java.",
        "Wait until I approve. Now compile Main.java.",
        "Wait for my signal. Now compile Main.java.",
        "As long as tests pass. Now compile Main.java.",
