...
from friday.agent_runtime import (
    ...
    _requests_current_outside_effect,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "PDF доступен по ссылке на сайте ведомства.",
        "Официальный отчёт доступен по ссылке.",
        "Документ проекта доступен по ссылке.",
        "Файл Росстата доступен здесь.",
        "Вложение письма находится по ссылке.",
        "При необходимости могу подготовить готовый PDF для вас.",
        "Могу подготовить для вас готовый PDF для вас.",
        "При необходимости подготовлю готовый PDF для вас.",
        "Файл отчёта скачать готов.",
        "Документ проекта проверить готов.",
        "Готовый к отправке документ могу проверить.",
        "Готовый для клиента документ могу подготовить.",
        "Готова к отправке документа.",
        "Файл к отправке проверить готов.",
        "Изображение в высоком разрешении проанализировать готова.",
        "Могу показать готовый документ — он доступен по ссылке.",
        "Готовый документ открывается по ссылке.",
        "Готовый PDF-отчёт доступен по ссылке.",
        "Готовый PDF отчёт доступен по ссылке.",
        "На официальном сайте ведомства готовый PDF доступен по ссылке.",
        "В открытом источнике готовый PDF доступен по ссылке.",
        "В интернете готовый PDF доступен по ссылке.",
        "По результатам поиска готовый PDF доступен по ссылке.",
        "Ведомство сообщает: готовый PDF доступен по ссылке.",
        "На странице результатов поиска готовый PDF доступен по ссылке.",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Файл финансового отчёта готов.",
        "Файл ежемесячного отчёта готов.",
        "Документ нового проекта готов.",
        "Отчёт отдела продаж готов.",
        "Картинка рыжего кота готова.",
        "Изображение высокого качества готово.",
        "Документы нового клиента готовы.",
        "Отчёт за август готов.",
        "Файл версии 2 готов.",
        "Файл отчёта за август готов.",
        "Документ для нового отдела продаж готов.",
        "Документ по проекту клиента готов.",
        "Отчёт за август 2026 готов.",
        ...
        "Могу показать готовый документ [скачать](https://example.test/file).",
        "Готовый итоговый документ; он уже у тебя.",
        "Готовая итоговая картинка: она ниже.",
        "Готовый финальный PDF ниже.",
        "Готовый файл отчёта — ссылка ниже.",
        "Готовый документ. Ссылка ниже.",
        "Готовый документ.",
        "Вот готовый итоговый документ.",
        "«Готовый документ; он уже для тебя",
        "`Готовый документ; он уже для тебя",
        "Готовый PDF файл уже у вас.",
        "Готовый файл PDF уже у вас.",
        "Готовый документ Word ниже.",
        "Готовая PDF-версия уже у вас.",
        "Готовый документ для нового отдела продаж доступен здесь.",
        "Готовый документ по проекту клиента доступен здесь.",
        "Готовый отчёт за август 2026 уже у вас.",
        "Готовый документ «Отчёт за август.pdf» уже у вас.",
        "Готовый документ `report.pdf` уже у вас.",
        "Готовый файл report.pdf уже у вас.",
        "По данным сайта, документ опубликован; готовый PDF уже у вас.",
        "На сайте опубликован старый отчёт, но готовый PDF уже у вас.",
        "На сайте есть описание, а готовый PDF уже у вас.",
        "На сайте я нашла сведения, готовый PDF уже у вас.",
        "Файл по проекту Alpha готов.",
        "Изображение в высоком разрешении готово.",
        "Готовая PNG-картинка ниже.",
        "Готовый к отправке документ; он уже для тебя.",
        "Готовый для клиента документ: ссылка ниже.",
...
@pytest.mark.parametrize(
    "statement",
    [
        "Готовый документ уже у тебя?",
        "Правда ли, что готовый документ уже у тебя?",
        "Если готовый документ уже у тебя, сообщи.",
        "Когда готовый документ уже у тебя, открой его.",
        "По словам автора, готовый документ уже у тебя.",
        "В инструкции сказано: готовый документ уже у тебя.",
        "Проверь, готовый документ уже у тебя?",
        "В примере написано `Готовый документ; он уже для тебя`.",
        'В примере написано "Готовый документ; он уже для тебя".',
        "Пример:\n```\nГотовый документ; он уже для тебя\n```",
        "На сайте готовый PDF доступен по ссылке.",
        "На сайте example.ru готовый PDF отчёта доступен по ссылке.",
        "По данным файла report.v2.txt, готовый PDF отчёта доступен по ссылке.",
        "Сайт сообщает: готовый PDF отчёта доступен по ссылке.",
        "Он сообщил, что готовый PDF отчёта доступен по ссылке.",
        "Автор утверждает, что готовый PDF отчёта доступен по ссылке.",
        "По данным сайта:\nГотовый PDF отчёта доступен по ссылке.",
        "В инструкции сказано:\nГотовый документ уже у тебя.",
        "Цитата:\nГотовый документ уже у тебя.",
    ],
)
def test_ready_carrier_examples_and_nonactual_context_are_not_handoffs(statement: str) -> None:
    assert not _claims_an_unconfirmed_supported_deed(
        statement,
        has_file=False,
        reminder_succeeded=False,
...
@pytest.mark.parametrize(
    ("claim", "descriptor"),
    [
        ("Готовая картинка: она ниже.", "image.png"),
        ("Готовый документ: ссылка ниже.", "report.pdf"),
        ("Готовый документ [скачать](https://example.test/file).", "report.pdf"),
...
def test_ready_carrier_location_is_not_part_of_artifact_evidence(
    ...
    assert not _claims_an_unconfirmed_supported_deed(
        ...
        file_format_descriptors=[descriptor],
    )


def test_ready_carrier_still_requires_the_claimed_artifact_format() -> None:
    assert _claims_an_unconfirmed_supported_deed(
        "Готовая картинка: она ниже.",
        has_file=True,
        reminder_succeeded=False,
    ...
    assert _claims_an_unconfirmed_supported_deed(
        "Готовый документ «Отчёт по зарплате» уже у вас.",
        has_file=True,
        reminder_succeeded=False,
    ...
    assert _claims_an_unconfirmed_supported_deed(
        ...
        has_file=True,
        reminder_succeeded=False,
        file_descriptors=["Первый.pdf"],
        file_format_descriptors=["Первый.pdf"],
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "ordinary",
            "Разбери этот документ.",
            "Вот этот документ как раз описывает архитектуру; ниже краткий разбор.",
        ),
        (
            "ordinary",
            "Опиши происхождение изображения.",
            "Изображение создано моделью Stable Diffusion и приведено как пример.",
        ),
        (
            "ordinary",
            "Сделай локальную подпись.",
            "report.docx: краткое резюме документа.",
        ),
        (
            "ordinary",
            "Опиши локальный узел.",
            "192.168.1.35: адрес ноутбука со вторым мозгом.",
        ),
        (
            "ordinary",
            "Explain the document history.",
            "Here is why the document was created by the customer.",
        ),
    ],
    ids=(
        "read-only-document",
        ...
        "document-deictic-prose",
        "external-image-model",
        "filename-is-not-web-host",
        "private-ip-is-not-web-host",
        "english-explanatory-head",
    ),
)
@pytest.mark.asyncio
...
@pytest.mark.parametrize(
    ("answer", "effects"),
    [
        ("Вот этот документ как раз описывает архитектуру; ниже краткий разбор.", frozenset()),
        ("Вот изображение из документа: на нём показан человек.", frozenset()),
        ("Я подготовила краткий разбор документа: ниже выводы.", frozenset()),
        ("Исходный документ загружен пользователем и содержит анкету.", frozenset()),
        ("Документ подготовлен автором и описывает доступные вам варианты.", frozenset()),
        ("Изображение создано моделью Stable Diffusion и приведено как пример.", frozenset()),
        ("Here is why the document was created by the customer.", frozenset()),
        ("Here is an analysis of the image generated by Stable Diffusion.", frozenset()),
        ("Чтобы заметка в Obsidian была создана, сначала выберите vault.", frozenset({"obsidian"})),
        ("Заметка в Obsidian не создана; проверьте доступ к vault.", frozenset({"obsidian"})),
        (
            "Вот результат анализа: заметка в Obsidian создана автоматически при синхронизации.",
            frozenset({"obsidian"}),
        ),
    ],
)
def test_supported_deed_guard_fails_open_for_explanations_and_source_state(
    answer: str,
    effects: frozenset[str],
) -> None:
    assert not _runtime_unconfirmed_supported_deed(
...
@pytest.mark.parametrize(
    ...
    [
        "Вот этот документ.",
        "Вот файл report.pdf.",
        "Я создала и прикрепила report.pdf.",
        "I created and attached report.pdf.",
        "Here is the file report.pdf.",
    ],
)
def test_narrow_supported_deed_guard_keeps_actual_handoffs_blocked(answer: str) -> None:
    assert _runtime_unconfirmed_supported_deed(
        answer,
        requested_effects=frozenset(),
        has_file=False,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("report.docx: краткое резюме документа.", False, False),
        ("Projects/Friday Test.md: заметка создана через Telegram.", False, False),
        ("192.168.1.35: адрес ноутбука со вторым мозгом.", False, False),
        ("На 192.168.1.35 указана локальная модель.", False, False),
        ("На report.docx указана дата.", False, False),
        ("На example.com указана актуальная цена.", False, True),
        ("Актуальные данные получить не удалось; ниже общая справка.", True, False),
        ("Текущая конфигурация QNAP зависит от версии прошивки.", True, False),
        ("Актуальная цена равна 100 рублям.", True, True),
    ],
)
...
@pytest.mark.parametrize(
    ("answer", "expected"),
    [
        ("I sent the PDF in this chat.", False),
        ("I delivered the document as an attachment.", False),
        ("I ordered a taxi.", True),
        ("I sent an email to the recipient.", True),
        ("Готово. Заказ оформлен после оплаты и появляется в истории.", False),
        ("Готово: заказ оформлен.", True),
    ],
)
def test_outside_deed_guard_requires_a_current_external_effect(answer: str, expected: bool) -> None:
    assert _claims_an_explicit_current_outside_deed(answer) is expected


@pytest.mark.parametrize(
    ("message", "expected"),
    [
        ("Как заказать такси?", False),
        ("Объясни, как перезапустить устройство.", False),
        ("Расскажи, как работает сервис, и закажи такси.", True),
        ("Закажи такси.", True),
    ],
)
def test_outside_effect_route_excludes_how_to_questions(message: str, expected: bool) -> None:
    assert _requests_current_outside_effect(message) is expected
