...
_DETAILED_REVIEW = (
    "Документ содержит 11 записей. У большинства записей отсутствуют полные даты, "
    "а у некоторых указаны только инициалы. Практический вывод: сведения нужно "
    "дополнить и перепроверить по первичным источникам."
)
