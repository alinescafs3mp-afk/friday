...
- Branch: `main`
- Deployed implementation head: `e8a34876eeb725608583c166545af2d6d3666d90`.
- Live: Friday `0.207.93` / `e8a34876eeb725608583c166545af2d6d3666d90`;
  tree `7e1b766911ea1b1578493e66acfb5e0066ada2939035d8951fbcaa102032442c`;
  wheel `ed2dd1d878f6f49581a53f5616b694613456e7ea3b01d31c8643779a2ea81297`.
- Immediate runtime predecessor: Friday `0.207.92` /
  `6804eaea940e804dc800a95aff712525bba9b694`; tree
  `637fad39989f74cf9a983c43fc462e8c3082d2fc3b593ea47e99af35d97399fd`.
...
- Production: immutable activation `clear`; backend and Telegram bridge active;
  ...
  index revision 20 with `0.207.93` current, `0.207.92` older and the
...
S4-R6 bounded conversation lexical refill and R7 five-contour document recall
...
remain live through `0.207.93`; P0H remains open only for a real
boot-start/quiescence absence authority and reviewed bounded deletion. S4-R8
remains unreleased until sole-facade parity is restored without legacy routing
regressions.
...
refill and R7 five-contour document recall are deployed in `0.207.93`. R8 sole
...
in `0.207.81`; R3 exact journey evidence is deployed in `0.207.84`, and physical Android
...
6. Keep released S6-R3 exact evidence green while P0G reduces the canonical
   gate without losing a unique release-blocking invariant.
