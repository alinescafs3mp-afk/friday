...
- Branch: `main`
- Deployed implementation head: `b5cf9b70f4493c8083c840bf8ce92b847ce5044b`.
- Live: Friday `0.207.94` / `b5cf9b70f4493c8083c840bf8ce92b847ce5044b`;
  tree `983cf655db523d0a7b8d91b0bc4d816d28ada5d763e0dc698d4ba70a8d3081a4`;
  wheel `4ff9a98f4458e46914774b393baba217cc90dcfe596024e69ceff0098a330a3c`.
- Immediate runtime predecessor: Friday `0.207.93` /
  `e8a34876eeb725608583c166545af2d6d3666d90`; tree
  `7e1b766911ea1b1578493e66acfb5e0066ada2939035d8951fbcaa102032442c`.
...
- Production: immutable activation `clear`; backend and Telegram bridge active;
  ...
  index revision 24 with `0.207.94` current, `0.207.93` older and the
...
are live. The inbox-advice worker now selects eligible privacy-safe rows before
...
remain live through `0.207.94`; P0H remains open only for a real
