...
Текущая версия: **0.207.61**. Owner-only Engineer Mode теперь является
...
Успешный canary startup должен показать в `/api/health` версию `0.207.61`,
