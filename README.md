...
Текущая версия: **0.207.13**. Авторизованный read-only `archive_search`
...
Успешный canary startup должен показать в `/api/health` версию `0.207.13`,
