...
Текущая версия: **0.207.25**. Авторизованный read-only `archive_search`
...
любой недоступности ноутбука или drift.
...
Успешный canary startup должен показать в `/api/health` версию `0.207.25`,
